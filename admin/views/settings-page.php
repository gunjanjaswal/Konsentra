...
$consent_banner_nest_opt = CONSENT_BANNER_NEST_OPTION;
?>
				...
				<div class="cp-card">
					...
					<table class="form-table" role="presentation">
						<tr>
							...
							<td>
								<label>
									<input type="checkbox" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[enabled]" value="1" <?php checked( $settings['enabled'] ); ?> />
						...
						<tr>
							...
							<td>
								<select id="cp-position" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[position]">
									<?php
									$consent_banner_nest_positions = array(
									...
									foreach ( $consent_banner_nest_positions as $consent_banner_nest_value => $consent_banner_nest_label ) {
										printf(
											'<option value="%1$s" %2$s>%3$s</option>',
											esc_attr( $consent_banner_nest_value ),
											selected( $settings['position'], $consent_banner_nest_value, false ),
											esc_html( $consent_banner_nest_label )
										);
									}
									?>
								</select>
						...
						<tr>
							...
							<td>
								<select id="cp-layout" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[layout]">
						...
						<tr>
							...
							<td>
								<input type="number" id="cp-expiry" min="1" max="3650" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[consent_expiry]" value="<?php echo esc_attr( $settings['consent_expiry'] ); ?>" class="small-text" />
						...
						<tr>
							...
							<td>
								<label class="cp-block">
									<input type="checkbox" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[show_reject]" value="1" <?php checked( $settings['show_reject'] ); ?> />
									<?php esc_html_e( 'Show a "Reject all" button', 'consent-banner-nest' ); ?>
								</label>
								<label class="cp-block">
									<input type="checkbox" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[show_settings]" value="1" <?php checked( $settings['show_settings'] ); ?> />
				...
				<div class="cp-card">
					...
					<table class="form-table" role="presentation">
						<tr>
							...
							<td><input type="text" id="cp-heading" class="regular-text" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[heading]" value="<?php echo esc_attr( $settings['heading'] ); ?>" /></td>
						</tr>
						<tr>
							<th scope="row"><label for="cp-message"><?php esc_html_e( 'Message', 'consent-banner-nest' ); ?></label></th>
							<td>
								<textarea id="cp-message" class="large-text" rows="4" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[message]"><?php echo esc_textarea( $settings['message'] ); ?></textarea>
						...
						<tr>
							...
							<td>
								...
								wp_dropdown_pages(
									array(
										'name'              => esc_attr( $consent_banner_nest_opt ) . '[privacy_page]',
										'id'                => 'cp-privacy-page',
										'selected'          => (int) $settings['privacy_page'],
										'show_option_none'  => esc_html__( '— None —', 'consent-banner-nest' ),
										'option_none_value' => 0,
									)
								);
								?>
						...
						<tr>
							...
							<td>
								<p><label class="cp-label-inline"><?php esc_html_e( 'Accept', 'consent-banner-nest' ); ?></label>
									<input type="text" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[accept_label]" value="<?php echo esc_attr( $settings['accept_label'] ); ?>" /></p>
								<p><label class="cp-label-inline"><?php esc_html_e( 'Reject', 'consent-banner-nest' ); ?></label>
									<input type="text" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[reject_label]" value="<?php echo esc_attr( $settings['reject_label'] ); ?>" /></p>
								<p><label class="cp-label-inline"><?php esc_html_e( 'Preferences', 'consent-banner-nest' ); ?></label>
									<input type="text" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[settings_label]" value="<?php echo esc_attr( $settings['settings_label'] ); ?>" /></p>
								<p><label class="cp-label-inline"><?php esc_html_e( 'Save', 'consent-banner-nest' ); ?></label>
									<input type="text" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[save_label]" value="<?php echo esc_attr( $settings['save_label'] ); ?>" /></p>
								<p><label class="cp-label-inline"><?php esc_html_e( 'Privacy link', 'consent-banner-nest' ); ?></label>
									<input type="text" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[privacy_label]" value="<?php echo esc_attr( $settings['privacy_label'] ); ?>" /></p>
							</td>
						</tr>
					</table>
				</div>
				...
				<div class="cp-card">
					...
					<table class="form-table" role="presentation">
						<tr>
							...
							<td><label><input type="checkbox" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[cat_functional]" value="1" <?php checked( $settings['cat_functional'] ); ?> /> <?php esc_html_e( 'Offer this category', 'consent-banner-nest' ); ?></label></td>
						</tr>
						<tr>
							<th scope="row"><?php echo esc_html( $categories['analytics']['label'] ); ?></th>
							<td><label><input type="checkbox" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[cat_analytics]" value="1" <?php checked( $settings['cat_analytics'] ); ?> /> <?php esc_html_e( 'Offer this category', 'consent-banner-nest' ); ?></label></td>
						</tr>
						<tr>
							<th scope="row"><?php echo esc_html( $categories['marketing']['label'] ); ?></th>
							<td><label><input type="checkbox" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[cat_marketing]" value="1" <?php checked( $settings['cat_marketing'] ); ?> /> <?php esc_html_e( 'Offer this category', 'consent-banner-nest' ); ?></label></td>
						</tr>
					</table>
				</div>
				...
				<div class="cp-card">
					...
					<table class="form-table" role="presentation">
						<tr>
							...
							<td>
								<label>
									<input type="checkbox" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[block_scripts]" value="1" <?php checked( $settings['block_scripts'] ); ?> />
				...
				<div class="cp-card">
					...
					<table class="form-table" role="presentation">
						<tr>
							...
							<td>
								<label>
									<input type="checkbox" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[log_consent]" value="1" <?php checked( $settings['log_consent'] ); ?> />
			...
			<div class="cp-admin-side">
				<div class="cp-card">
					...
					<p>
						...
						<input type="text" class="cp-color" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[bg_color]" value="<?php echo esc_attr( $settings['bg_color'] ); ?>" />
					</p>
					<p>
						<label class="cp-block-label"><?php esc_html_e( 'Text', 'consent-banner-nest' ); ?></label>
						<input type="text" class="cp-color" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[text_color]" value="<?php echo esc_attr( $settings['text_color'] ); ?>" />
					</p>
					<p>
						<label class="cp-block-label"><?php esc_html_e( 'Accent / buttons', 'consent-banner-nest' ); ?></label>
						<input type="text" class="cp-color" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[accent_color]" value="<?php echo esc_attr( $settings['accent_color'] ); ?>" />
					</p>
					<p>
						<label class="cp-block-label"><?php esc_html_e( 'Button text', 'consent-banner-nest' ); ?></label>
						<input type="text" class="cp-color" name="<?php echo esc_attr( $consent_banner_nest_opt ); ?>[button_text_color]" value="<?php echo esc_attr( $settings['button_text_color'] ); ?>" />
					</p>
				</div>
